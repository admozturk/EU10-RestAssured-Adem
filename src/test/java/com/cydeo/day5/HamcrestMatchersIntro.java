...
public class HamcrestMatchersIntro {
    ...
    public void stringHamcrest() {
      ...
      String text = "Batch EU10 is learning Hamcrest";

      //checking for equality is same as numbers
      assertThat(text,is("Batch EU10 is learning Hamcrest") );
      assertThat(text, equalTo("Batch EU10 is learning Hamcrest"));
      assertThat(text,is(equalTo("Batch EU10 is learning Hamcrest")));
